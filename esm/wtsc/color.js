import { rgb, px } from "@wormery/wtsc";
import { createHoverColor, createPressedColor, createDisabledColor, createTextColor, } from "./mixColor";
export default function defThemeKeys(p) {
    const createColorLevel = (color) => {
    ...
    const commonly = {
        ...
        boxShadow: p("0 2px 16px 0 rgba(0,0,0,0.1), 0 0 16px -2px rgba(0,0,0,0.06)"),
